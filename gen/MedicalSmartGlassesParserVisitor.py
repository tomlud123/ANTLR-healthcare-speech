...
class MedicalSmartGlassesParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MedicalSmartGlassesParser#trig_medication.
    def visitTrig_medication(self, ctx:MedicalSmartGlassesParser.Trig_medicationContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MedicalSmartGlassesParser#medications.
    def visitMedications(self, ctx:MedicalSmartGlassesParser.MedicationsContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by MedicalSmartGlassesParser#trig_message.
    def visitTrig_message(self, ctx:MedicalSmartGlassesParser.Trig_messageContext):
        return self.visitChildren(ctx)
