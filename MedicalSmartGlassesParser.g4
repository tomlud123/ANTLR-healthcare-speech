...
u14: SHOW data;
u15: SET NOTE note END NOTE | START DOCUMENTATION note END DOCUMENTATION;
u16: trig_medication MEDICATION medications END MEDICATION;
u17: trig_medication MEDICATION medications AT timestamp END MEDICATION;
u18: CHANGE PATIENT TO patient_name;
u19: trig_message MESSAGES;
u20: START (NEW)? MESSAGE note END (NEW)? MESSAGE (AND)? SEND IT TO patient_name;
